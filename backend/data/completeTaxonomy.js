const COMPLETE_CAT_TAXONOMY = {
  "Services": {
    ...
    "Daily Needs": ["Grocery Delivery", "Dairy Products", "Drinking Water Supply", "Pharmacy Delivery", "Household Essentials", "Pet Care Products"],
    "Food": ["Restaurants", "Cafes", "Fast Food", "Fine Dining", "Food Delivery", "Catering Services", "Bakery", "Cloud Kitchen"],
  ...
  "Daily Needs": {
    ...
    "Baby Care": ["Baby Diapers", "Baby Wipes", "Baby Powder", "Baby Soap", "Baby Shampoo", "Baby Care Products", "Baby Accessories", "Baby Food", "Feeding Bottles"],
...
module.exports = { COMPLETE_CAT_TAXONOMY };
